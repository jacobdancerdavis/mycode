...
"""Understanding dictionaries
    {key: value, key:value, ...}
    using dict.keys() and dict.value()"""
...
def main():
    ...
    ## proove that the switch is indeed a dictionary
    print(type(switch))
...
# or your program will continue to fail! if a KEY is requested that does not exist, an error will be thrown
